...
const idsToCloudinary = ids => ids.map(id => `https://res.cloudinary.com/marcelotokarnia/image/upload${cloudinaryTransformations}/v1601047079/projects/${id}`)
...
export const blog = idsToCloudinary([
  `blog1_bigeht.png`,
  `blog2_lbstkw.png`,
  `blog3_lftj00.png`,
])

export const reactReduxTypescript = idsToCloudinary([
